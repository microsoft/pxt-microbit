...
1) Connect **pin 0** to the **tip of the headphone jack** with a crocodile clip  

2) Connect **GND** to the **base of the headphone jack** using a second crocodile clip (usually black)  
